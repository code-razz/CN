...
int main()
{
    ...
    //op + strlen(ip) results in pointer arithmetic. Since op is a pointer to the beginning of the array , op + strlen(ip) points to the 5th character of op, which is the last 3 chars of op.
